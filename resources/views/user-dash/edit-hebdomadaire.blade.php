        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent1">
                    <form action="{{URL('editrepporthebdomadairepost')}}" method="post" id="form_sample_1" class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->date_rapport}}" name="date_rapport" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->code_rapport}}" name="code_rapport" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->psdmp}}" name="psdmp" data-required="1"
                                           class="form-control" />
                                    @if($errors->has('psdmp'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->psdmp_region}}" name="psdmp_region" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->nombre_patient}}" name="nombre_patient" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->semaine}}" name="semaine" data-required="1"
                                           class="form-control" />
