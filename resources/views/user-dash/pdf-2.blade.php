...
<div class="printthis">
    <button onclick="loadOtherPage()" class="btn btn-primary">Imprimer la fiche <i class="fa fa-print"></i> </button>
...
<script>
    function loadOtherPage2() {
        ...
        $("<iframe>")                             // create a new iframe element
            ...
            .attr("src", "{{ url('print-pdf/'.$membre->id) }}") // point the iframe to the page you want to print
            .appendTo("body");                    // add iframe to the DOM to cause it to load the page

    }
    function loadOtherPage() {

       window.location.href = "{{ url('print-pdf/'.$membre->id) }}";
