        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent1">
                    <form action="{{URL('ediiplanpost')}}" method="post" id="form_sample_1" class="form-horizontal">
                        @csrf
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="date" value="{{$data->date ?? ""}}" name="date" data-required="1"
                                           class="form-control" />
                                    @if($errors->has('date'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->mois ?? ""}}" name="mois" data-required="1"
                                           class="form-control" />
                                    @if($errors->has('mois'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->type_activite ?? ""}}" name="type_activite" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->secteur ?? ""}}" name="secteur" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->service ?? ""}}" name="service" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->medecin ?? ""}}" name="medecin" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->programme ?? ""}}" name="programme" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->objectif ?? ""}}" name="objectif" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->observation ?? ""}}" name="observation" data-required="1"
                                           class="form-control" />
