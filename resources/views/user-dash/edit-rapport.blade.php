        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent1">
                    <form action="{{URL('edit-rapport-journalier-post')}}" method="post" id="form_sample_1" class="form-horizontal">
                        @csrf
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_1}}" name="tache_1" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_2}}" name="tache_2" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_3}}" name="tache_3" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_4}}" name="tache_4" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_5}}" name="tache_5" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{$data->tache_6}}" name="tache_6" data-required="1"
                                           class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-control" name="remarque" id="" cols="30" rows="10">{{$data->remarque}}</textarea>
                                </div>
                            </div>
